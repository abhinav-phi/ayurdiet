      ...
      >
        ...
        <div className="relative z-10 w-full max-w-lg">
          <div className="mb-8 text-center text-[#141711]">
            ...
            <p className="text-lg text-[#4B5563]">Welcome back, Dietician!</p>
          </div>

          <div className="rounded-2xl bg-white/80 p-8 shadow-lg backdrop-blur-sm">
            <h2 className="mb-6 text-center text-3xl font-bold text-[#7FB069]">Log In to Your Account</h2>
            
            <div className="mb-6 flex rounded-lg bg-[#f0f5eb] p-1">
              <button
                className={`flex-1 rounded-md py-2 text-sm font-medium transition-colors ${
                  !useOTP 
                    ? 'bg-white text-[#7FB069] shadow-sm' 
                    : 'text-[#6b7c60] hover:text-[#7FB069]'
                }`}
              ...
              <div className="space-y-4">
                {!useOTP ? (
                  ...
                  <>
                    ...
                    <div>
                      <label className="text-base font-medium text-[#141711]" htmlFor="otp">
                        Enter OTP
                      </label>
                      <input
                        className="mt-2 flex w-full rounded-lg border border-[#e0e5dc] bg-white p-3 text-base placeholder:text-[#a1b092] focus:border-[#7FB069] focus:ring-[#7FB069] focus:outline-none focus:ring-2"
